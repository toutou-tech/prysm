...
// Hash: aa9b77d58ce0eca13952e69bf70a1941142e1c48680dd922af4c50ab2ee69433
package eth
...
// MarshalSSZ ssz marshals the SignedBlindedBeaconBlockEPBS object
func (s *SignedBlindedBeaconBlockEPBS) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBlindedBeaconBlockEPBS object to a target array
func (s *SignedBlindedBeaconBlockEPBS) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(BlindedBeaconBlockEPBS)
	}
	offset += s.Block.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the SignedBlindedBeaconBlockEPBS object
func (s *SignedBlindedBeaconBlockEPBS) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBlindedBeaconBlockEPBS object
func (s *SignedBlindedBeaconBlockEPBS) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the SignedBlindedBeaconBlockEPBS object
func (s *SignedBlindedBeaconBlockEPBS) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBlindedBeaconBlockEPBS object with a hasher
func (s *SignedBlindedBeaconBlockEPBS) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockEPBS object
func (b *BlindedBeaconBlockEPBS) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockEPBS object to a target array
func (b *BlindedBeaconBlockEPBS) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(84)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Body == nil {
		b.Body = new(BlindedBeaconBlockBodyEPBS)
	}
	offset += b.Body.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockEPBS object
func (b *BlindedBeaconBlockEPBS) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 84 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockEPBS object
func (b *BlindedBeaconBlockEPBS) SizeSSZ() (size int) {
	size = 84
...
// HashTreeRoot ssz hashes the BlindedBeaconBlockEPBS object
func (b *BlindedBeaconBlockEPBS) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockEPBS object with a hasher
func (b *BlindedBeaconBlockEPBS) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockBodyEPBS object
func (b *BlindedBeaconBlockBodyEPBS) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockBodyEPBS object to a target array
func (b *BlindedBeaconBlockBodyEPBS) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(388)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.BuilderBid == nil {
		b.BuilderBid = new(SignedBuilderBidCapella)
	}
	offset += b.BuilderBid.SizeSSZ()
	...
	// Field (9) 'BuilderBid'
	if dst, err = b.BuilderBid.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockBodyEPBS object
func (b *BlindedBeaconBlockBodyEPBS) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 388 {
		return ssz.ErrSize
	...
	// Field (9) 'BuilderBid'
	{
		...
		if err = b.BuilderBid.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockBodyEPBS object
func (b *BlindedBeaconBlockBodyEPBS) SizeSSZ() (size int) {
	size = 388
...
// HashTreeRoot ssz hashes the BlindedBeaconBlockBodyEPBS object
func (b *BlindedBeaconBlockBodyEPBS) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockBodyEPBS object with a hasher
func (b *BlindedBeaconBlockBodyEPBS) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (9) 'BuilderBid'
	if err = b.BuilderBid.HashTreeRootWith(hh); err != nil {
		return
	}
